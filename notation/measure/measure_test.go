...
func TestEmpty(t *testing.T) {
	...
	assert.Nil(t, m.Validate(big.NewRat(1, 1)))
...
func TestInvalidMeterChange(t *testing.T) {
	...
	m.MeterChange = meter.New(0, big.NewRat(1, 2))

	assert.NotNil(t, m.Validate(big.NewRat(1, 1)))
}
...
func TestInvalidDynamicChange(t *testing.T) {
	...
	m.DynamicChanges = append(m.DynamicChanges, change.New(rat.Zero(), 0.5, big.NewRat(-1, 1)))
...
func TestInvalidTempoChange(t *testing.T) {
	...
	// duration is negative
	m.TempoChanges = append(m.TempoChanges, change.New(rat.Zero(), 100.0, big.NewRat(-1, 1)))
...
func TestMarshalUnmarshal(t *testing.T) {
	...
	m1.DynamicChanges = append(m1.DynamicChanges, change.New(big.NewRat(1, 2), 0.5, big.NewRat(2, 1)))
